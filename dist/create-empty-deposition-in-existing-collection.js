...
export var create_empty_deposition_in_existing_collection = function (sandbox, collection_id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, get_id_for_latest_version_in_collection(sandbox, collection_id)];
            case 2:
                latest_id = _a.sent();
                return [4 /*yield*/, create_new_versioned_deposition(sandbox, latest_id)];
            case 3:
                new_id = _a.sent();
                return [4 /*yield*/, remove_files_from_draft(sandbox, new_id)];
            case 4:
                _a.sent();
                return [4 /*yield*/, update_deposition_metadata(sandbox, new_id, path.join(__dirname, './.zenodo.json.empty'))];
            case 5:
                _a.sent();
...
var create_new_versioned_deposition = function (sandbox, latest_id) { return __awaiter(void 0, void 0, void 0, function () {
...
var get_id_for_latest_version_in_collection = function (sandbox, collection_id) { return __awaiter(void 0, void 0, void 0, function () {
...
var remove_files_from_draft = function (sandbox, id) { return __awaiter(void 0, void 0, void 0, function () {
