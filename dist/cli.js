...
const add_js_1 = require("file/add.js");
const in_existing_collection_js_1 = require("deposition/create/in-existing-collection.js");
const in_new_collection_js_1 = require("deposition/create/in-new-collection.js");
const delete_js_1 = require("file/delete.js");
const delete_js_2 = require("deposition/delete.js");
const details_js_1 = require("deposition/show/details.js");
const publish_js_1 = require("deposition/publish.js");
const update_js_1 = require("metadata/update.js");
const latest_js_1 = require("deposition/show/latest.js");
const cli = () => {
    const create = (() => {
        ...
        create
            ...
            .action(() => {
            in_new_collection_js_1.create_empty_deposition_in_new_collection(zenodraft.opts().sandbox, zenodraft.opts().verbose);
        });
        create
            ...
            in_existing_collection_js_1.create_empty_deposition_in_existing_collection(zenodraft.opts().sandbox, collection_id, zenodraft.opts().verbose);
        });
        return create;
    })();
    const deposition = (() => {
        ...
        deposition
            ...
            .action((id) => {
            delete_js_2.delete_draft_deposition(zenodraft.opts().sandbox, id, zenodraft.opts().verbose);
        });
        deposition
            .command('details')
            .arguments('<id>')
            ...
            const details = yield details_js_1.get_deposition_details(zenodraft.opts().sandbox, id, zenodraft.opts().verbose);
        ...
        deposition
            ...
            const latest_draft_id = yield latest_js_1.get_latest_draft(zenodraft.opts().sandbox, collection_id, zenodraft.opts().verbose);
        ...
        deposition
            ...
            .action((id) => {
            publish_js_1.publish_draft_deposition(zenodraft.opts().sandbox, id, zenodraft.opts().verbose);
        });
        return deposition;
    })();
    const file = (() => {
        ...
        file
            ...
            .action((id, filename) => {
            add_js_1.add_file_to_deposition(zenodraft.opts().sandbox, id, filename, zenodraft.opts().verbose);
        });
        file
            .command('delete')
            .arguments('<id> <filename>')
            ...
            .action((id, filename) => {
            delete_js_1.delete_deposition_file(zenodraft.opts().sandbox, id, filename, zenodraft.opts().verbose);
        });
        return file;
    })();
    const metadata = (() => {
        ...
        metadata
            ...
            .action((id, filename) => {
            update_js_1.update_deposition_metadata(zenodraft.opts().sandbox, id, filename, zenodraft.opts().verbose);
        });
        metadata
            .command('clear')
            .arguments('<id>')
            ...
            .action((id) => {
            update_js_1.update_deposition_metadata(zenodraft.opts().sandbox, id, undefined, zenodraft.opts().verbose);
        });
        return metadata;
    })();
